...
pygame.display.set_caption("STAR WARS") # Title
ICON = pygame.image.load(
    os.path.join('Assets', 'X_WING.png'))
pygame.display.set_icon(ICON) # Title icon
...
BULLET_HIT_SOUND = pygame.mixer.Sound('Assets/bomb.mp3')
BULLET_FIRE_SOUND = pygame.mixer.Sound('Assets/LAZER.wav')
BULLET_FIRE_SOUND.set_volume(0.1)
MUSIC = pygame.mixer.Sound('Assets/SW-music.mp3')
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    ...
    yellow_health_text = HEALTH_FONT.render(
        "HEALT: " + str(yellow_health), 1, YELLOW)
